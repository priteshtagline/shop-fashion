    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vtov_products', models.ManyToManyField(related_name='VtovProduct', to='products.Product', verbose_name='Vtov Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.product')),
                ('similar_products', models.ManyToManyField(related_name='SimilarProduct', to='products.Product', verbose_name='Similar Product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.product')),
                ('recommended_products', models.ManyToManyField(related_name='RecommendedProduct', to='products.Product', verbose_name='Recommended Product')),
            ],
            options={

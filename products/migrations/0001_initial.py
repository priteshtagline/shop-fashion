    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_color', models.CharField(default='black', max_length=255)),
                ('display_order', models.PositiveIntegerField(default=0)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merchant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.merchant')),
            ],
            options={
                'db_table': 'product',
                'ordering': ['display_order'],
